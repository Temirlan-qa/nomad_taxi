...
class _$SignInResponseImpl implements _SignInResponse {
  const _$SignInResponseImpl({required this.status, required this.data});
  ...
  @override
  String toString() {
    return 'SignInResponse(status: $status, data: $data)';
  }
...
abstract class _SignInResponse implements SignInResponse {
  const factory _SignInResponse(
      ...
      required final DataResponse data}) = _$SignInResponseImpl;
