...
import '../../../features/auth/domain/repositories/auth_repository_impl.dart'
    as _i49;
import '../../../features/auth/domain/usecases/login_use_case.dart' as _i54;
...
import '../../../features/auth/domain/usecases/resend_code_use_case.dart'
    as _i53;
import '../../../features/auth/domain/usecases/verify_user_case.dart' as _i51;
...
import '../../../features/orders/domain/usecases/get_orders_use_case.dart'
    as _i30;
import '../../../features/orders/presentation/bloc/order_bloc.dart' as _i34;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i32.CreateOrderUseCase>(() => _i32.CreateOrderUseCase(
        gh<_i18.IOrdersRepository>(instanceName: 'OrdersRepositoryImpl')));
    gh.lazySingleton<_i33.FindTownIdUseCase>(() => _i33.FindTownIdUseCase(
        gh<_i18.IOrdersRepository>(instanceName: 'OrdersRepositoryImpl')));
    gh.factory<_i34.OrderBloc>(
        () => _i34.OrderBloc(gh<_i32.CreateOrderUseCase>()));
    gh.lazySingleton<_i35.UpdatePartnerDataUseCase>(() =>
        _i35.UpdatePartnerDataUseCase(gh<_i27.IProfileRepository>(
            instanceName: 'ProfileRepositoryImpl')));
    gh.lazySingleton<_i36.GetUserDataUseCase>(() => _i36.GetUserDataUseCase(
        gh<_i27.IProfileRepository>(instanceName: 'ProfileRepositoryImpl')));
    gh.lazySingleton<_i37.TogglePartnerStatusUseCase>(() =>
        _i37.TogglePartnerStatusUseCase(gh<_i27.IProfileRepository>(
            instanceName: 'ProfileRepositoryImpl')));
    gh.lazySingleton<_i38.WithdrawInfoUseCase>(() => _i38.WithdrawInfoUseCase(
        gh<_i27.IProfileRepository>(instanceName: 'ProfileRepositoryImpl')));
    gh.lazySingleton<_i39.LogOutUseCase>(() => _i39.LogOutUseCase(
        gh<_i27.IProfileRepository>(instanceName: 'ProfileRepositoryImpl')));
    gh.lazySingleton<_i40.UpdateFcmTokenUseCase>(() =>
        _i40.UpdateFcmTokenUseCase(gh<_i27.IProfileRepository>(
            instanceName: 'ProfileRepositoryImpl')));
    gh.lazySingleton<_i41.ActivatePromocodeUseCase>(() =>
        _i41.ActivatePromocodeUseCase(gh<_i27.IProfileRepository>(
            instanceName: 'ProfileRepositoryImpl')));
    gh.lazySingleton<_i42.UpdateUserInfoUseCase>(() =>
        _i42.UpdateUserInfoUseCase(gh<_i27.IProfileRepository>(
            instanceName: 'ProfileRepositoryImpl')));
    gh.lazySingleton<_i43.DeleteAccountUseCase>(() => _i43.DeleteAccountUseCase(
        gh<_i27.IProfileRepository>(instanceName: 'ProfileRepositoryImpl')));
    gh.lazySingleton<_i44.PayInfoUseCase>(() => _i44.PayInfoUseCase(
        gh<_i27.IProfileRepository>(instanceName: 'ProfileRepositoryImpl')));
    gh.lazySingleton<_i45.UpdateLanguageUseCase>(() =>
        _i45.UpdateLanguageUseCase(gh<_i27.IProfileRepository>(
            instanceName: 'ProfileRepositoryImpl')));
    gh.lazySingleton<_i46.IDriverOrderRepository>(
      () => _i47.DriverOrderRepository(
          gh<_i23.IDriverOrder>(instanceName: 'DriverOrderRemoteImpl')),
      instanceName: 'DriverOrderRepository',
    );
    gh.lazySingleton<_i48.IAuthRepository>(
      () => _i49.AuthRepositoryImpl(
          gh<_i16.IAuthService>(instanceName: 'AuthServiceImpl')),
      instanceName: 'AuthRepositoryImpl',
    );
    gh.lazySingleton<_i50.GetOrderStatusUseCase>(() =>
        _i50.GetOrderStatusUseCase(gh<_i46.IDriverOrderRepository>(
            instanceName: 'DriverOrderRepository')));
    gh.lazySingleton<_i51.VerifyUseCase>(() => _i51.VerifyUseCase(
        gh<_i48.IAuthRepository>(instanceName: 'AuthRepositoryImpl')));
    gh.lazySingleton<_i52.RefreshTokenUseCase>(() => _i52.RefreshTokenUseCase(
        gh<_i48.IAuthRepository>(instanceName: 'AuthRepositoryImpl')));
    gh.lazySingleton<_i53.ResendCodeUseCase>(() => _i53.ResendCodeUseCase(
        gh<_i48.IAuthRepository>(instanceName: 'AuthRepositoryImpl')));
    gh.lazySingleton<_i54.LoginUseCase>(() => _i54.LoginUseCase(
        gh<_i48.IAuthRepository>(instanceName: 'AuthRepositoryImpl')));
    return this;
  }
}
