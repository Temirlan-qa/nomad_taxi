...
import '../../../features/order_search/domain/repositories/i_search_order_repository.dart'
    as _i16;
import '../../../features/order_search/domain/usecases/get_cashback_info_use_case.dart'
    as _i23;
...
import '../../../features/orders/domain/usecases/create_order_use_case.dart'
    as _i36;
import '../../../features/orders/presentation/bloc/order_bloc.dart' as _i59;
  ...
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i22.GetSearchedAddressesUseCase>(() =>
        _i22.GetSearchedAddressesUseCase(gh<_i16.ISearchOrderRepository>(
            instanceName: 'SearchOrderRepositoryImpl')));
    gh.lazySingleton<_i23.GetCashbackInfoUseCase>(() =>
        _i23.GetCashbackInfoUseCase(gh<_i16.ISearchOrderRepository>(
            instanceName: 'SearchOrderRepositoryImpl')));
    gh.lazySingleton<_i24.IDriverOrder>(
      () => _i25.DriverOrderRemoteImpl(gh<_i26.OrderWebSocketClient>()),
      instanceName: 'DriverOrderRemoteImpl',
    );
    gh.lazySingleton<_i27.GetQuestionsUseCase>(() => _i27.GetQuestionsUseCase(
        gh<_i14.IHelpRepository>(instanceName: 'HelpRepositoryImpl')));
    gh.lazySingleton<_i28.IProfileRepository>(
      () => _i29.ProfileRepositoryImpl(
    ...
    gh.lazySingleton<_i35.WaitingForClientUseCase>(() =>
        _i35.WaitingForClientUseCase(
            gh<_i20.IOrdersRepository>(instanceName: 'OrdersRepositoryImpl')));
    gh.lazySingleton<_i36.CreateOrderUseCase>(() => _i36.CreateOrderUseCase(
        gh<_i20.IOrdersRepository>(instanceName: 'OrdersRepositoryImpl')));
    gh.lazySingleton<_i37.FindTownIdUseCase>(() => _i37.FindTownIdUseCase(
        gh<_i20.IOrdersRepository>(instanceName: 'OrdersRepositoryImpl')));
    gh.lazySingleton<_i38.UpdatePartnerDataUseCase>(() =>
        _i38.UpdatePartnerDataUseCase(gh<_i28.IProfileRepository>(
            instanceName: 'ProfileRepositoryImpl')));
    gh.lazySingleton<_i39.GetUserDataUseCase>(() => _i39.GetUserDataUseCase(
        gh<_i28.IProfileRepository>(instanceName: 'ProfileRepositoryImpl')));
    gh.lazySingleton<_i40.TogglePartnerStatusUseCase>(() =>
        _i40.TogglePartnerStatusUseCase(gh<_i28.IProfileRepository>(
            instanceName: 'ProfileRepositoryImpl')));
    ...
    gh.lazySingleton<_i43.UpdateFcmTokenUseCase>(() =>
        _i43.UpdateFcmTokenUseCase(gh<_i28.IProfileRepository>(
            instanceName: 'ProfileRepositoryImpl')));
    gh.lazySingleton<_i44.ActivatePromocodeUseCase>(() =>
        _i44.ActivatePromocodeUseCase(gh<_i28.IProfileRepository>(
            instanceName: 'ProfileRepositoryImpl')));
    gh.lazySingleton<_i45.UpdateUserInfoUseCase>(() =>
        _i45.UpdateUserInfoUseCase(gh<_i28.IProfileRepository>(
            instanceName: 'ProfileRepositoryImpl')));
    ...
    gh.lazySingleton<_i48.UpdateLanguageUseCase>(() =>
        _i48.UpdateLanguageUseCase(gh<_i28.IProfileRepository>(
            instanceName: 'ProfileRepositoryImpl')));
    gh.lazySingleton<_i49.IDriverOrderRepository>(
      () => _i50.DriverOrderRepository(
          gh<_i24.IDriverOrder>(instanceName: 'DriverOrderRemoteImpl')),
    ...
    gh.lazySingleton<_i58.LoginUseCase>(() => _i58.LoginUseCase(
        gh<_i51.IAuthRepository>(instanceName: 'AuthRepositoryImpl')));
    gh.factory<_i59.OrderBloc>(() => _i59.OrderBloc(
          gh<_i36.CreateOrderUseCase>(),
