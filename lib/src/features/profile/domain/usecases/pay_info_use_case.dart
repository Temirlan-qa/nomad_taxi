...
@lazySingleton
class PayInfoUseCase extends NoneInputBoundaryUseCase<dynamic> {
  final IProfileRepository _profileRepository;

  PayInfoUseCase(@Named.from(ProfileRepositoryImpl) this._profileRepository);

  @override
  Future<Either<DomainException, dynamic>> execute() async =>
      _profileRepository.payInfo();
}
