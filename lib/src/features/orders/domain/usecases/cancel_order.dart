...
@lazySingleton
class CancelOrderUseCase extends UseCase<OrderResponse, OrderRequest> {
  final IOrdersRepository _repository;

  CancelOrderUseCase(@Named.from(OrdersRepositoryImpl) this._repository);

  @override
  Future<Either<DomainException, OrderResponse>> execute(OrderRequest requestModel) async =>
