...
class CustomPinCodeFieldWidget extends StatefulWidget {
  ...
  @override
  State<CustomPinCodeFieldWidget> createState() =>
      _CustomPinCodeFieldWidgetState();
}
...
class _CustomPinCodeFieldWidgetState extends State<CustomPinCodeFieldWidget> {
  ...
  int getLength() {
    return widget.codeController.text.isEmpty
        ? 0
        : widget.codeController.text.length;
  }
