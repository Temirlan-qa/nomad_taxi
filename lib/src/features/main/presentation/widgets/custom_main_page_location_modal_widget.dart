...
class CustomMainPageLocationModalWidget extends StatefulWidget {
  const CustomMainPageLocationModalWidget({
    super.key,
  });

  @override
  State<CustomMainPageLocationModalWidget> createState() =>
      _CustomMainPageUpperModalWidgetState();
}

class _CustomMainPageUpperModalWidgetState
    extends State<CustomMainPageLocationModalWidget> {
  @override
