...
@lazySingleton
class WithdrawInfoUseCase extends NoneInputBoundaryUseCase<String> {
  final IBalanceRepository _balanceRepository;

  WithdrawInfoUseCase(
      @Named.from(BalanceRepositoryImpl) this._balanceRepository);

  @override
  Future<Either<DomainException, String>> execute() async =>
      _balanceRepository.withdrawInfo();
}
