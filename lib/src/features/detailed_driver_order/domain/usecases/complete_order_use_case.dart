...
@lazySingleton
class CompleteOrderUseCase extends NoneOutputBoundaryUseCase<OrderRequest> {
  CompleteOrderUseCase(@Named.from(OrdersRepositoryImpl) this._repository);
  ...
  Future<Either<DomainException, void>> execute(
      ...
      await _repository.completeOrder(requestModel);
}
