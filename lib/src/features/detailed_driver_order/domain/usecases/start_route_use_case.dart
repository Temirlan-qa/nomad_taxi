...
@lazySingleton
class StartRouteUseCase extends NoneOutputBoundaryUseCase<OrderRequest> {
  StartRouteUseCase(@Named.from(OrdersRepositoryImpl) this._repository);
  ...
  Future<Either<DomainException, void>> execute(
      ...
      await _repository.startRoute(requestModel);
}
